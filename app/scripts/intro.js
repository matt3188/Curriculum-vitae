...
(function() {
  ...
  var shadow = intro.settings.hasShadow,
      element = ( ( typeof intro.settings.listEl !== 'undefined' ) ? intro.settings.listEl : 'ul' );
  ...
  intro.populateIntro = function() {
    ...
    intro += '<p>' + this.introText + '</p>';

    document.getElementById( this.settings.sectionName ).innerHTML += intro;
  };
